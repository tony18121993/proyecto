 ...
 * @author TONY
 */
public class jpPersonalAdd extends javax.swing.JPanel {

    /**
     * Creates new form jpPersonalAdd
     */
    public jpPersonalAdd() {
        initComponents();
    }
    ...
    private void btnaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddActionPerformed
        ...
        try{
            per.add(getCampos());
            JOptionPane.showMessageDialog(this, "Personal agregado correctamente,cierre esta ventana para ver los cambios");
